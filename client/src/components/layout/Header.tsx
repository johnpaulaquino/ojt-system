...
export default function Header() {
  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 bg-white dark:bg-[#111111] border-b border-gray-200 dark:border-gray-800 sticky top-0 z-10">
      ...
      <div className="flex items-center gap-4">
        ...
        {mounted && (
          <button
            ...
            className="cursor-pointer p-2 rounded-full text-gray-500 hover:text-yellow-400 hover:bg-yellow-400/20 dark:text-gray-400 dark:hover:bg-yellow-400/20 transition-colors"
          >

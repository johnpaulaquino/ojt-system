  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Activity Logs</h1>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Comprehensive tracking of student time-in and time-out records.
          </p>
        </div>
        <button className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#1a1a1a] hover:bg-gray-100 dark:hover:bg-gray-800 border border-gray-200 dark:border-gray-800 text-gray-900 dark:text-white text-sm font-semibold rounded-lg transition-colors cursor-pointer">
          <Download size={16} />
          Export CSV
        </button>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-800 rounded-lg bg-white dark:bg-[#0a0a0a] text-sm text-gray-900 dark:text-gray-300 placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors"
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <select 
              ...
              className="flex-1 block w-full py-2.5 px-3 border border-gray-300 dark:border-gray-800 rounded-lg bg-white dark:bg-[#0a0a0a] text-sm text-gray-900 dark:text-gray-300 focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors appearance-none cursor-pointer"
            >
            ...
            <button className="p-2.5 border border-gray-300 dark:border-gray-800 rounded-lg bg-white dark:bg-[#0a0a0a] hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-600 dark:text-gray-400 transition-colors cursor-pointer">
              <Filter size={18} />
            </button>
          </div>
        </div>
                ...
                {currentActivityLogs.map((log) => (
                  <tr key={log.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/20 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-gray-900 dark:text-white font-medium">{log.date}</div>
                      <div className="text-gray-500 text-xs mt-0.5">{log.day}</div>
                    </td>

                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 flex items-center justify-center text-xs font-semibold shrink-0">
                          {log.initials}
                        </div>
                        <div>
                          <div className="text-gray-900 dark:text-white font-medium">{log.name}</div>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300 font-medium">
                        <LogOut size={14} className="text-gray-400 dark:text-gray-500" />
                        {log.timeOut}
                      </div>
                    </td>

                    <td className="px-6 py-4 whitespace-nowrap text-center font-medium">
                      <span className={log.isDurationAlert ? "text-red-600 dark:text-red-500" : "text-gray-700 dark:text-gray-300"}>
                        {log.duration}
                      </span>
                    </td>
                      ...
                      <span
                        className={`inline-flex items-center justify-center px-3 py-1 rounded-full text-[10px] font-bold tracking-wide uppercase border ${
                          log.status === 'Verified'
                            ...
                            : 'bg-red-50 text-red-700 border-red-200 dark:bg-red-500/10 dark:text-red-4 00 dark:border-red-500/20'
                        }`}
                      >
                        {log.status}
                      </span>
